...
def split_chapter(chapter_num, base_dir=None):
    """Split all topics in a chapter"""
    if base_dir is None:
        # Default to autolinkedin data directory
...
def split_all_chapters(base_dir=None):
...
def main():
    ...
    parser.add_argument('--base-dir', default=None,
                        help='Base directory containing chapter folders (default: ../data relative to script)')
